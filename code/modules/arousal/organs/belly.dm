	...
	"belly_prefix" = list(
		"1" = list(
			list(BELLY_SHAPE_TUMMY = "slim",
				...
				BELLY_SHAPE_UDDERS = "set of saggy",),
		...
		"8" = list(
			list(BELLY_SHAPE_TUMMY = "massive boulder of",
				...
				BELLY_SHAPE_UDDERS = "gigantic, floor-dragging"),
		...
		"12" = list(
			list(BELLY_SHAPE_TUMMY = "description-defying",
				...
				BELLY_SHAPE_UDDERS = "description defying"),
			),
		),
	"belly_suffix" = list(
		"1" = list(
		...
		"9" = list(
			list(BELLY_SHAPE_TUMMY = "a belly packed so full with soft, supple fat that it appears to have a belly of its own",
				...
				BELLY_SHAPE_UDDERS = "udders packed so full with sloshy milk"),
