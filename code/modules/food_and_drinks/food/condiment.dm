...
/obj/item/reagent_containers/food/condiment/rasberryjam
	name = "Rasberry Jam"
	desc = "A jar of sweet rasberry jam"
	icon_state = "rasberryjam"
	list_reagents = list(/datum/reagent/consumable/rasberryjam = 50)
